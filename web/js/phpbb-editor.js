...
*
* This block requires jQuery + phpbb core namespace (from phpBB's core.js).
* It is optional for basic BBCode insertion. Wrapped so it fails silently
* if jQuery is not present on the page (e.g. the Bible interlinear pages).
*/
if (typeof jQuery !== 'undefined') {
	(function($) {
		$(document).ready(function() {
			...
			if (typeof form_name === 'undefined' || typeof text_name === 'undefined') {
				return;
			}
			...
			if (document.forms[form_name]) {
				doc = document;
			} else if (typeof opener !== 'undefined' && opener.document && opener.document.forms[form_name]) {
				doc = opener.document;
			} else {
				return;
			}
			...
			// Only call if the phpbb namespace with the helper is available
			if (typeof phpbb !== 'undefined' && typeof phpbb.applyCodeEditor === 'function') {
				phpbb.applyCodeEditor(textarea);
			}
			if (typeof phpbb !== 'undefined' && typeof phpbb.showDragNDrop === 'function' && $('#attach-panel').length) {
